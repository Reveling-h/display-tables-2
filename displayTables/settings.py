"""
Django settings for displayTables project.
...
SECRET_KEY = 'django-insecure-dxi!h%gh)gn^qpc8(2vx04(t*x4up(=1$*j#yb@wb+vz1apf_g'
...
ROOT_URLCONF = 'displayTables.urls'
...
WSGI_APPLICATION = 'displayTables.wsgi.application'
